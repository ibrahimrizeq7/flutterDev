...
class CornealDetials extends StatefulWidget {
  @override
  _CornealDetialsState createState() => _CornealDetialsState();
}
          ...
          showDialog(
              ...
              builder: (context) {
                return new AlertDialog(
                  title: new Text("Corneal Doctor's"),
                  actions: <Widget>[
                    new FlatButton.icon(
...
class _CornealDetialsState extends State<CornealDetials> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
            ...
            children: <Widget>[
              Expanded(
                child: MaterialButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(child: new Text("What is Corneal")),
              ...
              Expanded(
                child: MaterialButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(child: new Icon(Icons.remove_red_eye)),
                      Expanded(child: new Text("ما هي القرنية")),
                    ],
                  ),
                ),
              ),
