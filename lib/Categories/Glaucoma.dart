...
class GlaucomaDetials extends StatefulWidget {
  @override
  _GlaucomaDetialsState createState() => _GlaucomaDetialsState();
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView(scrollDirection: Axis.vertical, children: <Widget>[
        Category(
          imagecaption: "Glaucoma Doctor's",
          ...
          showDialog(
              ...
              builder: (context) {
                return new AlertDialog(
                  title: new Text("Glaucoma Doctor's"),
                  actions: <Widget>[
                    new FlatButton.icon(
                      label: Text(' د/ وســـام شحـادة ',
                          style: TextStyle(
...
class _GlaucomaDetialsState extends State<GlaucomaDetials> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
            ...
            children: <Widget>[
              Expanded(
                child: MaterialButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(child: new Text("What is Glaucoma")),
              ...
              Expanded(
                child: MaterialButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(child: new Icon(Icons.remove_red_eye)),
                      Expanded(child: new Text("ما هو الماء الاسود")),
                    ],
                  ),
                ),
              ),
