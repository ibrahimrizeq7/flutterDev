...
class SquintDetials extends StatefulWidget {
  @override
  _SquintDetialsState createState() => _SquintDetialsState();
}
          ...
          showDialog(
              ...
              builder: (context) {
                return new AlertDialog(
                  title: new Text("Squint Doctor's"),
                  actions: <Widget>[
                    new FlatButton.icon(
                      label: Text(' د/  معـــتز الغـرايبة ',
                          style: TextStyle(
                    ...
                    new FlatButton.icon(
                      label: Text(' د/ غـــادة عبدالحافظ',
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.black)),
                      icon: Icon(Icons.save),
...
class _SquintDetialsState extends State<SquintDetials> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: Text('Squint and cliled'),
        actions: <Widget>[
          new IconButton(
              icon: Icon(
                Icons.search,
            ...
            children: <Widget>[
              Expanded(
                child: MaterialButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(child: new Text("What is Squint")),
              ...
              Expanded(
                child: MaterialButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(child: new Icon(Icons.remove_red_eye)),
                      Expanded(child: new Text("ما هو الحّـــول  ")),
                    ],
                  ),
                ),
              ),
